...
export function QuestBar() {
  ...
  return (
    <button
      type="button"
      onClick={() => router.history.push(mission.to)}
      className="mx-auto flex w-full max-w-5xl items-center gap-3 rounded-card border-[3px] border-ink bg-yellow px-3 py-3 text-left shadow-chunky-sm"
    >
      <img
        src={host.portrait}
        alt=""
        draggable={false}
        className="pointer-events-none h-12 w-auto object-contain object-bottom"
      />
