...
export const guides: Guide[] = [
  {
    slug: "como-responder-cuando-no-sabemos",
    title: "¿Y si no sé? Cómo responder una pregunta infantil sin inventar una respuesta",
    kicker: "Sala de Grandes",
    minutes: 7,
    topics: ["Cuando no sabemos la respuesta"],
    lede: "No saber no debilita la confianza: puede convertir una pregunta inesperada en una pequeña investigación compartida.",
    sections: [
      { title: "La situación real", body: [
      ...
      { title: "Qué significa en la práctica", body: [
      ...
      { title: "Cuatro cosas que podrían probar", body: [
      ...
      { title: "Qué conviene evitar", body: [
  ...
  {
    slug: "hablar-cambio-climatico-sin-miedo",
    title: "Cómo hablar del cambio climático sin instalar miedo permanente",
    kicker: "Sala de Grandes",
    minutes: 8,
    topics: ["Clima: verdad sin miedo permanente"],
    lede: "Los niños necesitan información honesta, emociones escuchadas y acciones proporcionales; no la tarea imposible de salvar solos el planeta.",
    sections: [
      { title: "La situación real", body: [
  ...
  {
    slug: "matematicas-familiares-sin-miedo",
    title: "Matemáticas familiares para quienes crecieron temiéndoles",
    kicker: "Sala de Grandes",
    minutes: 8,
    topics: ["Matemáticas sin heredar el miedo"],
    lede: "No hace falta convertirse en profesor ni esconder la propia historia: se puede acompañar desde los patrones, las preguntas y la vida cotidiana.",
    sections: [
      { title: "La situación real", body: [
      ...
      { title: "Cinco cosas que podrían probar", body: [
  ...
  {
    slug: "pantallas-creativas-y-pasivas",
    title: "Pantallas creativas y pantallas pasivas: una diferencia más útil que contar minutos",
    kicker: "Sala de Grandes",
    minutes: 8,
    topics: ["No todas las pantallas hacen lo mismo"],
    lede: "Los minutos importan, pero también qué desplazan, qué ocurre en la pantalla, con quién se usa y qué idea logra salir de ella.",
    sections: [
      { title: "La situación real", body: [
  ...
  {
    slug: "inteligencia-artificial-infancia",
    title: "Inteligencia artificial en la infancia: posibilidades, límites y preguntas",
    kicker: "Sala de Grandes",
    minutes: 9,
    topics: ["IA en la infancia, con criterio"],
    lede: "La pregunta no es solo si un niño puede usar IA, sino para qué, bajo qué condiciones y qué capacidad humana queremos que siga practicando.",
    sections: [
      { title: "La situación real", body: [
  ...
  {
    slug: "aprender-invento-no-funciona",
    title: "Qué aprende un niño cuando inventa algo que no funciona",
    kicker: "Sala de Grandes",
    minutes: 8,
    topics: ["Cuando el invento no funciona"],
    lede: "Un prototipo que falla no es una lección automática de perseverancia: se vuelve aprendizaje cuando ayuda a observar, cambiar algo y volver a probar.",
    sections: [
      { title: "La situación real", body: [
  ...
  {
    slug: "valor-aburrimiento-bien-acompanado",
    title: "El valor del aburrimiento bien acompañado",
    kicker: "Sala de Grandes",
    minutes: 8,
    topics: ["Aburrirse sin quedar solo"],
    lede: "No hace falta llenar cada silencio ni abandonar al niño a su suerte: acompañar puede ser sostener el tiempo sin dirigir lo que debe ocurrir.",
    sections: [
      { title: "La situación real", body: [
  ...
  {
    slug: "sostenibilidad-sin-perfeccion-culpa",
    title: "Sostenibilidad familiar sin perfección ni culpa",
    kicker: "Sala de Grandes",
    minutes: 9,
    topics: ["Sostenibilidad familiar posible"],
    lede: "Una familia no necesita comprar una vida ‘verde’ ni hacerlo todo: puede observar sus condiciones, elegir una práctica y conectarla con cambios colectivos.",
    sections: [
      { title: "La situación real", body: [
