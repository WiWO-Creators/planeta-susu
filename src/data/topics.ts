...
export type LessonBlock =
  | { type: "say"; who: CharacterSlug; text: string }
  | { type: "text"; title?: string; body: string }
  | { type: "list"; title: string; items: string[] }
  | { type: "try"; title: string; steps: string[] }
  | { type: "callout"; tone: "tip" | "wow" | "care"; text: string };
...
export const topics: Topic[] = [
  {
    ...
    forParents: "Sostenibilidad con agencia concreta, sin culpa ni eco-ansiedad. Acción proporcional.",
    lessons: [
      {
        slug: "el-rio-tiene-sed",
      ...
      },
      {
        ...
        quiz: {
          ...
          options: [
            { text: "Comprar más cosas verdes.", ok: false, why: "Comprar más, aunque sea «eco», sigue siendo más." },
            {
              text: "Usar menos, reparar y reusar. Reciclar viene después.",
              ok: true,
              why: "¡Sí! La mejor basura es la que no se produce.",
            },
            { text: "Esconder la basura bajo la cama.", ok: false, why: "Zizú revisa debajo de las camas. Se sabe el truco." },
          ],
        },
      },
    ],
  },
  {
    ...
    colorToken: "vector",
    emojiLabel: "cosmos",
    forKids: "Por qué el cielo es azul, cómo funcionan los sentidos y qué significa «todavía no lo sabemos».",
    forParents: "Ciencia como práctica: observar, conjeturar, contrastar. La incertidumbre se nombra.",
    lessons: [
      {
        slug: "cielo-azul",
        ...
        quiz: {
          ...
          options: [
            { text: "Porque el mar se refleja hacia arriba como un espejo gigante.", ok: false, why: "El cielo es azul también en el desierto, lejos del mar." },
            {
              text: "Porque el aire dispersa el color azul de la luz del sol.",
              ok: true,
              why: "¡Bingo! Se llama dispersión. Gadú lo anotó en su mapa.",
            },
            { text: "Porque alguien pinta el cielo cada mañana a las seis.", ok: false, why: "Hermoso, pero no. Aunque Margarel se ofrece de voluntaria." },
          ],
        },
      },
      {
        ...
        quiz: {
          ...
          options: [
            { text: "Solo para disfrutar el recreo.", ok: false, why: "El recreo es sagrado, pero los sentidos también miden el mundo." },
            {
              text: "Son herramientas para observar, comparar y descubrir.",
              ok: true,
              why: "Los sentidos son el laboratorio que siempre llevas puesto.",
            },
            { text: "No sirven: solo valen las máquinas.", ok: false, why: "Las máquinas ayudan. El asombro empieza en el cuerpo." },
          ],
        },
      },
    ],
  },
  {
    ...
    forParents: "Antes del símbolo, la acción. Mentalidad de crecimiento, no identidad de «bueno o malo en mates».",
    lessons: [
      {
        slug: "patrones-gadu",
        ...
        age: "4–8",
        host: "vector",
        summary: "Un patrón es una promesa que se repite. Si la escuchas, puedes adivinar lo que sigue.",
        blocks: [
          {
            type: "say",
            who: "gadu",
        ...
        quiz: {
          ...
          options: [
            { text: "Violeta.", ok: true, why: "La regla es ABAB. Después de naranja vuelve el violeta." },
            { text: "Verde, porque Zizú se coló.", ok: false, why: "Zizú es un excelente explorador, pero no es parte de esta regla." },
            { text: "Se acaba la cola.", ok: false, why: "Las colas de Gadú son larguísimas. El patrón sigue." },
          ],
        },
      },
      {
        ...
        quiz: {
          ...
          options: [
            { text: "32, porque se pegan los números.", ok: false, why: "Pegar dígitos es otra operación. Aquí juntamos colecciones." },
            { text: "5 planetas.", ok: true, why: "3 y 2 se juntan: 5. Puedes contarlo con los dedos." },
            { text: "1, porque se comen entre sí.", ok: false, why: "Los planetas de cartón no son tan dramáticos." },
          ],
        },
      },
    ],
  },
  {
    ...
    forParents: "Pensamiento computacional: descomponer, reconocer patrones, abstraer, algoritmos. Pantalla opcional.",
    lessons: [
      {
        slug: "recetas-algoritmos",
        ...
        quiz: {
          ...
          options: [
            { text: "Un bicho que vive dentro de la tablet.", ok: false, why: "Aunque Zizú estaría encantado de catalogarlo." },
            {
            ...
            { text: "Señal de que no sirves para programar.", ok: false, why: "Falso y feo. Hasta las personas expertas depuran todo el día." },
          ],
        },
      },
      {
        ...
        age: "5–9",
        host: "gadu",
        summary: "Moverse por un mapa con flechas: arriba, abajo, izquierda, derecha. Eso es un programa.",
        blocks: [
          {
            type: "say",
            who: "gadu",
        ...
        quiz: {
          ...
          options: [
            { text: "Borrar todo y llorar un rato largo.", ok: false, why: "Llorar está permitido. Borrar todo, no siempre. Ajusta un paso." },
            {
              text: "Mirar qué paso falló y cambiar esa flecha.",
              ok: true,
              why: "Depurar es mirar con lupa, no rehacer el universo.",
            },
            { text: "Culpar a la roca.", ok: false, why: "Las rocas son honestas. El programa es el que se puede editar." },
          ],
        },
      },
    ],
  },
  {
    ...
    forParents: "Proceso antes que producto. Creatividad con prueba. Identidad latinoamericana en el telar y el color.",
    lessons: [
      {
        slug: "colores-que-sienten",
        ...
        quiz: {
          ...
          options: [
            { text: "Verde.", ok: true, why: "Como el chaleco de Zizú. Un bosque en miniatura." },
            { text: "Se pelean y queda gris siempre.", ok: false, why: "El gris aparece si mezclas muchos. Amarillo + azul es verde." },
            { text: "Nada, los colores no se hablan.", ok: false, why: "Los colores son muy habladores. Pregúntale a Margarel." },
          ],
        },
      },
      {
        ...
        quiz: {
          ...
          options: [
            { text: "Los caminos y las historias de su abuela.", ok: true, why: "El textil es memoria. Un mapa que se puede vestir." },
            { text: "Las reglas de un colegio muy estricto.", ok: false, why: "Las rayas de Margarel no son un reglamento." },
            { text: "Nada: son solo decoración.", ok: false, why: "Decorar también es decir algo. Aquí, además, hay historia." },
          ],
        },
      },
    ],
    ...
    lessons: [
      {
        ...
        quiz: {
          ...
          options: [
            { text: "Seguir jugando más rápido para que no moleste.", ok: false, why: "Eso cierra la puerta. Susu las abre." },
            {
            ...
            { text: "Decirle que vuelva cuando sea menos violeta.", ok: false, why: "El violeta es justamente el punto. Diferente es información." },
          ],
        },
      },
      {
        slug: "emociones-tienen-nombre",
        ...
        quiz: {
          ...
          options: [
            { text: "Para que desaparezca de inmediato y nunca vuelva.", ok: false, why: "Las emociones van y vuelven. Nombrarlas las hace más manejables, no las borra." },
            {
              text: "Para entender el mensaje y elegir un paso chiquito.",
              ok: true,
              why: "Susu aprueba. El nombre es una linterna, no un interruptor.",
            },
            { text: "Para tener razón en una pelea.", ok: false, why: "Nombrar no es ganar. Es entenderse." },
          ],
        },
      },
    ],
  },
  {
    ...
    forParents: "Agencia proporcional y alfabetización de futuros. Sin distopías ni «salvar el planeta está en tus manos».",
    lessons: [
      {
        slug: "oficios-que-no-existen",
        title: "Oficios que todavía no existen",
        minutes: 7,
        age: "6–10",
        host: "vector",
        summary: "Cuando seas grande, puede que tu trabajo tenga un nombre que hoy da risa. Eso es una buena señal.",
        blocks: [
          {
            type: "say",
            who: "vector",
        ...
        quiz: {
          ...
          options: [
            { text: "Memorizar todas las respuestas de un libro viejo.", ok: false, why: "Los libros sirven. La memorización sola se queda corta." },
            {
            ...
            { text: "Esperar a ser grande y ya ver.", ok: false, why: "El futuro se ensaya hoy. Hasta en el patio." },
          ],
        },
      },
      {
        slug: "robots-con-corazon",
        title: "Robots con corazón",
        minutes: 7,
        age: "6–10",
        host: "gadu",
        summary: "La tecnología no es magia ni amenaza: es una herramienta. Las personas eligen para qué.",
        blocks: [
          {
            type: "say",
            who: "gadu",
        ...
        quiz: {
          ...
          options: [
            { text: "El robot, porque tiene botones.", ok: false, why: "Los botones no firman. Las personas sí." },
            {
            ...
            { text: "Nadie. Aparece solo.", ok: false, why: "Si apareciera solo, Margarel ya habría pedido el truco." },
          ],
        },
      },
    ],
  },
  {
    ...
    forParents: "Exploración situada, consentimiento y una mirada latinoamericana que produce conocimiento.",
    lessons: [
      {
        slug: "casco-puesto",
        ...
        age: "5–10",
        host: "margarel",
        summary: "Explorar no es entrar corriendo. Es prepararse, preguntar y escuchar a quienes ya viven ahí.",
        blocks: [
          {
            type: "say",
            who: "margarel",
        ...
        quiz: {
          ...
          options: [
            { text: "Correr a sacar fotos de todo.", ok: false, why: "Eso es invadir, no explorar." },
            {
            ...
            { text: "Inventar cómo es, desde la nave.", ok: false, why: "Desde lejos parece un dibujo. De cerca, es otra historia." },
          ],
        },
      },
      {
        slug: "tejido-que-cuenta",
        title: "Un tejido que es un mapa",
        minutes: 7,
        age: "6–11",
        host: "margarel",
        summary: "En los Andes, un textil puede guardar caminos, ríos y memoria. Las matemáticas y el arte se sientan juntas.",
        blocks: [
          {
            type: "say",
            who: "margarel",
        ...
        quiz: {
          ...
          options: [
            { text: "Porque es bonito.", ok: false, why: "Lo bonito no alcanza. Hay información adentro." },
            {
            ...
            { text: "Porque todos los mapas son de lana.", ok: false, why: "Algunos son de papel. Este, de gestos repetidos." },
          ],
        },
      },
    ],
...
export function getLesson(tema: string, leccion: string) {
  const topic = getTopic(tema);
  return topic?.lessons.find((l) => l.slug === leccion);
}
